(() => {
  ...
  window.ANOTHER_HOUSE_DATA = {
    ...
    pages: {
      ...
      transport: { title: I('찾아오는 길', 'Getting here', 'アクセス', '交通路线'), kicker: 'TRANSPORT', hero: '/assets/images/arrival.webp', summary: I('동대문역 6번 출구에서 도보 약 30초, 선일빌딩 5층입니다.', 'We are on the 5th floor of Sunil Building, about 30 seconds from Dongdaemun Station Exit 6.', '東大門駅6番出口から徒歩約30秒、ソニルビル5階です。', '从东大门站6号出口步行约30秒，位于Sunil大厦5层。'), sections: [
