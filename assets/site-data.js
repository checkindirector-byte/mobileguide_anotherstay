(() => {
  ...
  window.ANOTHER_HOUSE_DATA = {
    ...
    pages: {
      ...
      laundry: { title: I('세탁 안내', 'Laundry guide', '洗濯案内', '洗衣指南'), kicker: 'LAUNDRY', hero: '/assets/images/laundry.webp', model: 'LG FY9WTB · wash 9 kg / dry 4.5 kg', manualUrl: 'https://www.lge.co.kr/support/product-F9WTB', manualLabel: I('LG 공식 설명서', 'LG official manual', 'LG公式説明書', 'LG官方说明书'), guideImage: I('/assets/images/guides/official-lg.webp','/assets/images/guides/official-lg-en.webp','/assets/images/guides/official-lg-en.webp','/assets/images/guides/official-lg-en.webp'), summary: I('드라이브의 실물 사진과 숙소 안내문, LG FY9WTB 공식 자료를 기준으로 세탁·건조 방법을 정리했습니다. 세제와 섬유유연제는 세탁기 위 선반에 있습니다.', 'This guide follows the hostel photo and instructions plus LG FY9WTB documentation. Detergent and fabric softener are on the shelf above the machine.', '宿の実物写真・案内文とLG FY9WTB公式資料を基にまとめました。洗剤と柔軟剤は洗濯機上の棚にあります。', '本指南依据住宿实物照片、说明及LG FY9WTB官方资料。洗涤剂和柔顺剂位于洗衣机上方搁板。'), sections: [{ title: I('기본 사용', 'Basic use', '基本操作', '基本使用'), steps: I(['세탁물을 넣고 문을 완전히 닫은 뒤, 위 선반의 세제와 섬유유연제를 적정량 넣습니다.','전원 ON/OFF 버튼을 누릅니다.','다이얼로 표준 세탁·쾌속 세탁·건조 등 원하는 코스를 선택합니다.','START/STOP 버튼을 눌러 시작합니다. 밤 10시 이전에 이용을 마쳐 주세요.','완료 후 세탁물을 바로 꺼내고 세제 투입구와 문을 열어 둡니다. 건조 후에는 먼지 필터를 정리해 주세요.','건조 직후 내부와 세탁물이 매우 뜨거우니 화상에 주의하세요.'],['Load laundry, close the door fully, then add the correct amount of detergent and softener from the shelf above.','Press ON/OFF.','Use the dial to choose Standard Wash, Quick Wash, Dry, or another suitable cycle.','Press START/STOP. Please finish using the machine before 22:00.','Remove laundry promptly, leave the detergent drawer and door open, and clean the lint filter after drying.','The drum and laundry are very hot immediately after drying; take care to avoid burns.'],['洗濯物を入れて扉を閉め、上の棚にある洗剤と柔軟剤を適量入れます。','ON/OFFを押します。','ダイヤルで標準洗濯・スピード洗濯・乾燥などを選びます。','START/STOPを押します。22時までに利用を終えてください。','終了後はすぐ取り出し、洗剤投入口と扉を開け、乾燥後は糸くずフィルターを掃除します。','乾燥直後は内部と衣類が非常に熱いため、やけどに注意してください。'],['放入衣物并关好门，从上方搁板取适量洗涤剂和柔顺剂加入。','按ON/OFF电源键。','旋钮选择标准洗、快速洗、烘干等合适程序。','按START/STOP开始。请在22:00前结束使用。','结束后及时取出衣物，敞开洗涤剂盒和机门，烘干后清理绒毛过滤器。','烘干结束后内筒和衣物非常烫，请谨防烫伤。']) }]},
