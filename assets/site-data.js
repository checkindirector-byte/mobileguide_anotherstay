(() => {
  ...
  window.ANOTHER_HOUSE_DATA = {
    ...
    pages: {
      ...
      checkout: { title: I('셀프 체크아웃', 'Self check-out', 'セルフチェックアウト', '自助退房'), kicker: 'DEPARTURE', hero: '/assets/images/double-window.webp', summary: I('체크아웃은 오전 11시까지입니다.', 'Check-out is by 11:00.', 'チェックアウトは11時までです。', '请于11:00前退房。'), sections: [
