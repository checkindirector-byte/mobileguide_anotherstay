(() => {
  ...
  D.pages.nearby = {
    ...
    summary: I(
      ...
      '从东大门老店到广藏市场、昌信洞和乙支路，综合评价、评论量与本地特色精选。'
    ),
    categories: [
      { id: 'host', label: I('추천', 'Host picks', 'おすすめ', '推荐') },
      { id: 'all', label: I('전체', 'All', 'すべて', '全部') },
      { id: 'breakfast', label: I('아침·해장', 'Breakfast', '朝食', '早餐') },
      { id: 'korean', label: I('한식·노포', 'Korean', '韓国料理', '韩餐') },
      { id: 'market', label: I('시장·길거리', 'Market', '市場グルメ', '市场美食') },
      { id: 'global', label: I('글로벌', 'Global', '多国籍', '国际风味') },
      { id: 'special', label: I('특별한 식사', 'Special dining', '特別な食事', '特别用餐') },
      { id: 'cafe', label: I('카페·디저트', 'Cafe & dessert', 'カフェ', '咖啡甜点') },
      { id: 'late', label: I('늦은 밤', 'Late night', '深夜', '深夜') },
    ],
    searchPlaceholder: I(
      '식당명, 메뉴, 분위기를 검색해 보세요',
    ...
    hostTitle: I('호스트 추천 7곳', '7 Host’s Picks', 'ホストおすすめ7選', '房东推荐7家'),
    hostCopy: I(
    ...
    sourceNote: I(
      ...
      '评分及评论数截至2026年7月28日Google Maps查询，可能变动。到访前请再次确认营业时间、休息日及排队情况。'
    ),
    places: [
      place('duck', {
        query: '별난오리 동대문',
        name: I('별난오리', 'Byeolnan Ori', 'ピョルナンオリ', '别样鸭'),
        category: I('한식·오리', 'Korean · Duck', '韓国料理・鴨', '韩餐·鸭肉'),
        categories: ['korean', 'special', 'late'],
        host: true,
        rating: '4.9',
        reviews: '2,739',
        walk: I('도보 약 5분', 'About 5 min walk', '徒歩約5分', '步行约5分钟'),
        text: I(
          ...
          '本地常客众多的鸭肉专门店，适合多人丰盛聚餐。'
        ),
        tags: I(['로컬 단골', '리뷰 최다급', '여럿이'], ['Local favorite', 'High review volume', 'Groups'], ['地元人気', '口コミ多数', 'グループ'], ['本地人气', '高评论量', '多人聚餐']),
      }),
      place('jinokhwa', {
        query: '진옥화할매원조닭한마리',
        name: I('진옥화할매원조닭한마리', 'Jin Ok-hwa Original Chicken', '陳玉華ハルメ元祖タッカンマリ', '陈玉华奶奶元祖一只鸡'),
        category: I('한식·노포', 'Korean · Institution', '韓国料理・老舗', '韩餐·老店'),
        categories: ['korean', 'late'],
        host: true,
        rating: '4.1',
        reviews: '8,350',
        walk: I('도보 약 8분', 'About 8 min walk', '徒歩約8分', '步行约8分钟'),
        text: I(
          ...
          '一只鸡胡同的代表老店，清鸡汤配年糕，最后以刀切面收尾。'
        ),
        tags: I(['닭한마리', '서울 노포', '대기 가능'], ['Dakhanmari', 'Seoul institution', 'Expect a wait'], ['タッカンマリ', 'ソウル老舗', '待ち時間あり'], ['一只鸡', '首尔老店', '可能排队']),
      }),
      place('buchon', {
        query: '부촌육회 본점',
        name: I('부촌육회 본점', 'Buchon Yukhoe', 'プチョンユッケ 本店', '富村生拌牛肉 总店'),
        category: I('광장시장·한식', 'Gwangjang · Korean', '広蔵市場・韓国料理', '广藏市场·韩餐'),
        categories: ['market', 'korean', 'special'],
        host: true,
        rating: '4.4',
        reviews: '2,193',
        walk: I('도보 약 20분', 'About 20 min walk', '徒歩約20分', '步行约20分钟'),
        text: I(
          ...
          '广藏市场生拌牛肉代表店，入选米其林必比登，适合搭配活章鱼。'
        ),
        tags: I(['미쉐린 빕 구르망', '육회', '광장시장'], ['MICHELIN Bib Gourmand', 'Yukhoe', 'Gwangjang Market'], ['ミシュラン', 'ユッケ', '広蔵市場'], ['米其林必比登', '生拌牛肉', '广藏市场']),
        detailUrl: 'https://guide.michelin.com/kr/en/seoul-capital-area/kr-seoul/restaurant/buchon-yukhoe',
      }),
      place('everest', {
        query: '에베레스트 레스토랑 동대문',
        name: I('에베레스트 레스토랑', 'Everest Restaurant', 'エベレスト・レストラン', '珠穆朗玛餐厅'),
        category: I('네팔·인도', 'Nepali · Indian', 'ネパール・インド', '尼泊尔·印度'),
        ...
        text: I(
          ...
          '东大门老牌尼泊尔餐厅，可品尝咖喱、坦都里和蒸饺，并有素食选择。'
        ),
        tags: I(['동대문 아이콘', '채식 옵션', '모모'], ['Dongdaemun icon', 'Vegetarian options', 'Momo'], ['東大門名店', 'ベジ対応', 'モモ'], ['东大门名店', '素食选择', '尼泊尔饺子']),
        detailUrl: 'http://www.everestfood.com/',
      }),
      place('coffee', {
        query: '커피한약방',
        name: I('커피한약방', 'Coffee Hanyakbang', 'コーヒー韓薬房', '咖啡韩药房'),
        category: I('카페·디저트', 'Cafe · Dessert', 'カフェ・デザート', '咖啡·甜点'),
        categories: ['cafe', 'special'],
        host: true,
        rating: '4.5',
        reviews: '2,378',
        walk: I('도보 약 25분', 'About 25 min walk', '徒歩約25分', '步行约25分钟'),
        text: I(
          ...
          '藏在乙支路小巷的复古名店，适合以手冲咖啡和甜点收尾。'
        ),
        tags: I(['을지로 감성', '핸드드립', '사진 명소'], ['Euljiro mood', 'Hand drip', 'Photogenic'], ['乙支路レトロ', 'ハンドドリップ', 'フォトスポット'], ['乙支路复古', '手冲咖啡', '拍照打卡']),
        detailUrl: 'https://coffeehanyakbang.com/',
      }),
      place('jokbal', {
        query: '창신동매운족발',
        name: I('창신동매운족발', 'Changsin-dong Spicy Jokbal', '昌信洞メウンチョッパル', '昌信洞辣猪蹄'),
        category: I('한식·야식', 'Korean · Late night', '韓国料理・夜食', '韩餐·夜宵'),
        categories: ['korean', 'late'],
        host: true,
        rating: '4.1',
        reviews: '917',
        ...
        text: I(
          ...
          '炭香与辣味鲜明的昌信洞夜宵代表，适合嗜辣旅客。'
        ),
        tags: I(['매운맛', '숯불 향', '포장 가능'], ['Spicy', 'Charcoal aroma', 'Takeaway'], ['激辛', '炭火香', 'テイクアウト'], ['香辣', '炭火香', '可打包']),
      }),
      place('jeonju', {
        query: '전주집 동대문 생선구이',
        name: I('전주집', 'Jeonjujip', 'チョンジュチプ', '全州家'),
        category: I('생선구이·노포', 'Grilled fish · Institution', '焼き魚・老舗', '烤鱼·老店'),
        ...
        text: I(
          ...
          '东大门烤鱼胡同经典店，炭火烤鱼套餐也适合独自用餐。'
        ),
        tags: I(['생선구이 골목', '혼밥', '아침 식사'], ['Grilled-fish alley', 'Solo friendly', 'Breakfast'], ['焼き魚横丁', '一人OK', '朝食'], ['烤鱼胡同', '适合单人', '早餐']),
      }),
      place('seoulzip', {
        query: '서울집 을지로',
        name: I('서울집', 'Seoulzip', 'ソウルチプ', '首尔之家'),
        category: I('컨템퍼러리·와인', 'Contemporary · Wine', '現代料理・ワイン', '现代料理·葡萄酒'),
        categories: ['special', 'late'],
        host: false,
        rating: '4.7',
        reviews: '479',
        walk: I('도보 약 15분', 'About 15 min walk', '徒歩約15分', '步行约15分钟'),
        text: I(
          ...
          '位于DDP与乙支路之间，适合搭配葡萄酒享受精致晚餐。'
        ),
        tags: I(['데이트', '와인', '분위기'], ['Date night', 'Wine', 'Atmosphere'], ['デート', 'ワイン', '雰囲気'], ['约会', '葡萄酒', '氛围']),
      }),
      place('pho', {
        query: '퍼항 동대문',
        name: I('퍼항', 'Pho Hang', 'フォーハン', 'Pho Hang 越南粉'),
        category: I('베트남', 'Vietnamese', 'ベトナム料理', '越南料理'),
        ...
        text: I(
          ...
          '香草与浓郁汤底突出的越南餐厅，晚间想喝热汤时很合适。'
        ),
        tags: I(['쌀국수', '늦은 영업', '현지식'], ['Pho', 'Open late', 'Authentic'], ['フォー', '深夜営業', '本場風'], ['越南粉', '营业较晚', '地道风味']),
      }),
      place('soonhee', {
        query: '원조순희네빈대떡 광장시장',
        name: I('원조순희네빈대떡', 'Original Soonhee Bindaetteok', '元祖スニネピンデトッ', '元祖顺姬家绿豆煎饼'),
        category: I('광장시장·길거리', 'Gwangjang · Street food', '広蔵市場・屋台', '广藏市场·街头美食'),
        ...
        text: I(
          ...
          '在广藏市场热闹氛围中品尝酥脆绿豆煎饼，适合搭配米酒。'
        ),
        tags: I(['빈대떡', '시장 음식', '막걸리'], ['Bindaetteok', 'Market food', 'Makgeolli'], ['ピンデトッ', '市場グルメ', 'マッコリ'], ['绿豆煎饼', '市场美食', '米酒']),
      }),
      place('haejang', {
        query: '대화정 진짜해장국 동대문',
        name: I('대화정 진짜해장국', 'Daehwajeong Jinjja Haejangguk', 'テファジョン チンチャヘジャングク', '大和亭醒酒汤'),
        category: I('아침·해장국', 'Breakfast · Haejangguk', '朝食・ヘジャングク', '早餐·醒酒汤'),
        categories: ['breakfast', 'korean', 'late'],
        host: false,
        rating: '4.2',
        reviews: '760',
        walk: I('도보 약 4분', 'About 4 min walk', '徒歩約4分', '步行约4分钟'),
        text: I(
          ...
          '清早想吃饱时的近距离选择，浓郁汤底也深受本地上班族喜爱。'
        ),
        tags: I(['해장국', '아침 가능', '도보 4분'], ['Haejangguk', 'Early meal', '4 min walk'], ['ヘジャングク', '朝食', '徒歩4分'], ['醒酒汤', '早餐', '步行4分钟']),
      }),
    ],
  };
})();
